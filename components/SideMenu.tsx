...
import { Users, Phone, MapPin, Bookmark, Settings, HelpCircle, Lock, User, Shield, LogOut, BadgeCheck, Info, Radio } from 'lucide-react';
        ...
        <>
          ...
          >
            ...
            <div className="p-4 text-center text-gray-400 text-sm border-t border-gray-100">
              ...
              <div className="text-xs mt-0.5">v2.1 beta</div>
            </div>
          </motion.div>
        </>
      )}
