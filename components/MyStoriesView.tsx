    ...
    >
      ...
      >
        ...
        <div className="flex-1">
          <h1 className="text-lg font-semibold">Мои истории</h1>
          <p className="text-sm opacity-80">Создание и управление историями</p>
        </div>
      </motion.div>
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm">
            Истории будут доступны после настройки базы данных
          </p>
        </div>
      </div>
    </motion.div>
