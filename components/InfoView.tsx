  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-[17px] font-medium flex-grow">О приложении</div>
      </div>

      <div className="flex-grow overflow-y-auto pt-14 p-4">
        <div className="bg-white rounded-xl p-4 shadow-sm">
          <Info size={48} className="text-blue-500 mx-auto mb-4" />
          <h2 className="text-[20px] font-medium text-center mb-2">HouseGram</h2>
          <p className="text-[15px] text-gray-600 text-center">
            Версия 1.1.0-beta.
            Это приложение создано для общения с известными личностями.
          </p>
        </div>
      </div>
    </motion.div>
