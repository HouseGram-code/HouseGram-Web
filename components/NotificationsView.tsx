...
import { ArrowLeft, Bell, Volume2, BarChart3 } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex-grow overflow-y-auto pt-4 pb-10 no-scrollbar bg-gray-50">
        ...
        <div className="bg-white border-y border-gray-100 mb-4">
          <div className="px-4 py-2 text-[14px] font-medium" style={{ color: themeColor }}>Статистика</div>
          
          <div 
            className="flex items-center px-4 py-3 gap-4 cursor-pointer hover:bg-gray-50 transition-colors"
            onClick={() => setView('notification-stats')}
          >
            <div className="text-gray-500"><BarChart3 size={24} /></div>
            <div className="flex flex-col flex-grow">
              <span className="text-[16px] text-black">Статистика уведомлений</span>
              <span className="text-[13px] text-gray-500">Просмотр аналитики доставки</span>
            </div>
