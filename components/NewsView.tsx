...
export default function NewsView() {
  ...
  const news: Array<{
  ...
  }> = [
    {
      ...
      description: 'Отличные новости! Теперь вы можете покупать молнии (Lightning) двумя способами: обычными деньгами через криптовалюту или Telegram Stars — официальной валютой Telegram. Выбирайте удобный способ и наслаждайтесь всеми возможностями HouseGram!',
      date: '21 апреля 2026',
      icon: '⚡'
    }
  ];
